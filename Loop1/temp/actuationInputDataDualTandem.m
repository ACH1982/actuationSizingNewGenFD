...
clear all
% Input data --------------------------------------------------------------
Hm1_req = 70e3; % Hinge moment at high speed [N*m]
Hm1_stiffness = Hm1_req * 2.75 * sizingCriteria;
Hm1 = max(Hm1_req,Hm1_stiffness);
Hm2 = 24.5e3; % Hinge moment at low speed [N*m]
