...
load('actuationInputDataListStiffnessSizing.mat')
% Conversion---------------------------------------------------------------
...
QNL1_m3s = loadFlowMargin * armArea * dotdelta1_rad;
QNL2_m3s = loadFlowMargin * armArea * dotdelta2_rad / sqrt(1 - hingeRatio);
